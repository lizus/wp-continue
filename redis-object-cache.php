...
if ( ! defined( 'WP_CACHE_KEY_SALT' ) ) define( 'WP_CACHE_KEY_SALT', $_SERVER['SERVER_NAME'] );
...
if ( ! defined( 'WP_CACHE_KEY' ) ) define('WP_CACHE_KEY', 'vitara');
...
class WP_Object_Cache {
	...
	protected function _key( $key = '', $group = 'default' ) {
		...
		//return preg_replace( '/\s+/', '', WP_CACHE_KEY_SALT . ":U:$prefix$group:$key" );
		return preg_replace( '/\s+/', '', WP_CACHE_KEY_SALT . ":".WP_CACHE_KEY.":$prefix$group:$key" );
	}
